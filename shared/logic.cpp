...
void Schema::borderConditions() {
    ...
    for(int j = H0; j < B; j++) {
        ...
        grid[L0][j].psi[0] = 3.*(grid[L0+1][j].psi[0] - grid[L0][j].psi[0])/(dy*dy)
                                - grid[L0+1][j].ksi[0]/2.;
        grid[L2-1][j].psi[0] = 3.*(grid[L2-2][j].psi[0] - grid[L2-1][j].psi[0])/(dy*dy)
                                - grid[L2-2][j].ksi[0]/2.;
    }
    ...
    grid[L0][H0-1].psi[0] = grid[L0][H0].psi[0]/(dy*dy) + grid[L0-1][H0-1].psi[0]/(dx*dx);
    grid[L2-1][H0-1].psi[0] = grid[L2-1][H0].psi[0]/(dy*dy) + grid[L2][H0-1].psi[0]/(dx*dx);

    /* Andle tube's sides cross */
    grid[L0+H2-1][YSize-1].ksi[0] = 3.*grid[L0+H2-1][YSize-2].ksi[0]/(dy*dy)
                                    - grid[L0+H2-1][YSize-2].ksi[0]/2.;
    grid[L2-H2][YSize-1].ksi[0] = 3.*grid[L2-H2][YSize-2].ksi[0]/(dy*dy)
